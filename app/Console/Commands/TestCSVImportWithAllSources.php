...
class TestCSVImportWithAllSources extends Command
{
    protected $signature = 'baremetrics:test-csv-import-all-sources 
                           {csv_file : Ruta al archivo CSV}
                           {--name=Test CSV Import : Nombre de la comparación}';
    
    protected $description = 'Prueba la importación de CSV verificando contra TODOS los sources de Baremetrics';
    ...
    public function handle()
    {
        ...
        $this->info("🧪 Probando importación de CSV con verificación de todos los sources...");
